...
class _Codec {
  static GeolocationResult decodeResult(String data) => _JsonCodec.resultFromJson(json.decode(data));

  static LocationResult decodeLocationResult(String data) => _JsonCodec.locationResultFromJson(json.decode(data));

  static String encodeLocationPermission(LocationPermission permission) => _Codec.platformSpecific(
  ...
  static dynamic platformSpecific({
    ...
    if (Platform.isAndroid) {
      ...
      throw new GeolocationException('Unsupported platform: ${Platform.operatingSystem}');
    }
  }
...
class _JsonCodec {
  static GeolocationResult resultFromJson(Map<String, dynamic> json) => GeolocationResult(
        json['isSuccessful'],
  ...
  static GeolocationResultError resultErrorFromJson(Map<String, dynamic> json) {
    final GeolocationResultErrorType? type = _mapResultErrorTypeJson(json['type']);
    ...
    final GeolocationResultError error = GeolocationResultError(
      type,
      json['message'],
      additionalInfo,
    );
  ...
  static LocationResult locationResultFromJson(Map<String, dynamic> json) => LocationResult(
        json['isSuccessful'],
        json['error'] != null ? resultErrorFromJson(json['error']) : null,
        json['data'] != null
            ? (json['data'] as List<dynamic>).map((it) => locationFromJson(it as Map<String, dynamic>)).toList()
            : null,
      );
  ...
  static Map<String, dynamic> locationUpdatesRequestToJson(_LocationUpdatesRequest request) => {
        'id': request.id,
  ...
  static Map<String, dynamic> permissionRequestToJson(_PermissionRequest request) => {
